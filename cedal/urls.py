...
from .views import altaTarjeta, cantidadPedidos, configuracion, credito, graficoClientes, graficoProductos, index, graficoCompras, prodVencimiento, reportesCompras, comprasRango
