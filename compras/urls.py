...
from compras.views import compraAdeudada, detallePago, eliminarCompra, eliminarPago, imprimir, index, altaCompra, productoAutocomplete, proveedorAutocomplete, cargarCompra, cargarDetalleCompra, detallesCompra, registroPago, reporteCompra, reporteCompras, pago, detalleFormaPago
